...
KNOWN_SETTINGS = [
    ...
    Setting(section="TrafficControlQueueingDiscipline", name="NetworkEmulatorDelayJitterSec", allowedValue=NumericValue(lower=0), sinceRel="2.44"),
    Setting(section="TrafficControlQueueingDiscipline", name="NetworkEmulatorDelaySec", allowedValue=NumericValue(lower=0), sinceRel="2.44"),
    Setting(section="TrafficControlQueueingDiscipline", name="NetworkEmulatorDuplicateRate", allowedValue=NumericValue(lower=0, upper=100, suffixes=["%"]), sinceRel="2.44"),
    Setting(section="TrafficControlQueueingDiscipline", name="NetworkEmulatorLossRate", allowedValue=NumericValue(lower=0, upper=100, suffixes=["%"]), sinceRel="2.44"),
    Setting(section="TrafficControlQueueingDiscipline", name="NetworkEmulatorPacketLimit", allowedValue=NumericValue(lower=0, upper=4294967294), sinceRel="2.44"),
    Setting(section="TrafficControlQueueingDiscipline", name="Parent", allowedValue=EnumValue(value=["root", "clsact"]), sinceRel="2.44"),
