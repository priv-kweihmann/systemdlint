...
KNOWN_SETTINGS = [
    ...
    Setting(section="Address", name="RouteMetric", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.49"),
    ...
    Setting(section="Automount", name="ExtraOptions", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="BridgeFDB", name="OutgoingInterface", allowedValue=TextValue(), sinceRel="2.49"),
    ...
    Setting(section="BridgeMDB", name="MulticastGroupAddress", allowedValue=IPorUrlValue(), sinceRel="2.47"),
    Setting(section="BridgeMDB", name="VLANId", allowedValue=NumericValue(lower=0, upper=4094), sinceRel="2.47"),
    ...
    Setting(section="CAKE", name="AutoRateIngress", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="CAKE", name="Bandwidth", allowedValue=NumericValue(base=1000, suffixes=["K", "M", "G"]), sinceRel="2.46"),
    Setting(section="CAKE", name="CompensationMode", allowedValue=EnumValue(["none", "atm", "ptm"]), sinceRel="2.50"),
    Setting(section="CAKE", name="FirewallMark", allowedValue=NumericValue(lower=1, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAKE", name="FlowIsolationMode", allowedValue=EnumValue(["none", "src-host", "dst-host", "hosts", "flows", "dual-src-host", "dual-dst-host", "triple"]), sinceRel="2.50"),
    Setting(section="CAKE", name="Handle", allowedValue=NumericValue(lower=1, upper=0xffff, numberBase=16), sinceRel="2.46"),
    Setting(section="CAKE", name="MPUBytes", allowedValue=NumericValue(lower=0, upper=256), sinceRel="2.50"),
    Setting(section="CAKE", name="NAT", allowedValue=BooleanValue(), sinceRel="2.50"),
    ...
    Setting(section="CAKE", name="PriorityQueueingPreset", allowedValue=EnumValue(["besteffort", "precedence", "diffserv8", "diffserv4", "diffserv3"]), sinceRel="2.50"),
    Setting(section="CAKE", name="SplitGSO", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="CAKE", name="UseRawPacketSize", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="CAKE", name="Wash", allowedValue=BooleanValue(), sinceRel="2.50"),
    ...
    Setting(section="CAN", name="ClassicDataLengthCode", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="CAN", name="DataPhaseBufferSegment1", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAN", name="DataPhaseBufferSegment2", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAN", name="DataPropagationSegment", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAN", name="DataSamplePoint", allowedValue=TextValue(), sinceRel="2.46"), ## TODO: percentage value
    Setting(section="CAN", name="DataSyncJumpWidth", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAN", name="DataTimeQuantaNSec", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    ...
    Setting(section="CAN", name="Loopback", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="CAN", name="OneShot", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="CAN", name="PhaseBufferSegment1", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAN", name="PhaseBufferSegment2", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAN", name="PresumeAck", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="CAN", name="PropagationSegment", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAN", name="RestartSec", allowedValue=TimeValue()),
    Setting(section="CAN", name="SamplePoint", allowedValue=TextValue()),
    Setting(section="CAN", name="SyncJumpWidth", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="CAN", name="Termination", allowedValue=BooleanValue(), sinceRel="2.46"),
    Setting(section="CAN", name="TimeQuantaNSec", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    ...
    Setting(section="DHCPPrefixDelegation", name="Announce", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="DHCPPrefixDelegation", name="Assign", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="DHCPPrefixDelegation", name="ManageTemporaryAddress", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="DHCPPrefixDelegation", name="RouteMetric", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.50"),
    Setting(section="DHCPPrefixDelegation", name="SubnetId", allowedValue=NumericValue(upper=0x7fffffffffffffff, numberBase=16), sinceRel="2.46"),
    Setting(section="DHCPPrefixDelegation", name="Token", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="DHCPPrefixDelegation", name="UplinkInterface", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="DHCPServer", name="RelayTarget", allowedValue=IPValue(), sinceRel="2.49"),
    Setting(section="DHCPServer", name="Router", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="DHCPServer", name="ServerAddress", allowedValue=IPValue(), sinceRel="2.49"),
    ...
    Setting(section="DHCPServer", name="UplinkInterface", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="DHCPServerStaticLease", name="Address", allowedValue=IPValue(), sinceRel="2.49"),
    Setting(section="DHCPServerStaticLease", name="MACAddress", allowedValue=MacAddressValue(), sinceRel="2.49"),
    ...
    Setting(section="DHCPv4", name="Label", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="DHCPv4", name="RoutesToNTP", allowedValue=BooleanValue(), sinceRel="2.49"),
    ...
    Setting(section="DHCPv4", name="Use6RD", allowedValue=BooleanValue(), sinceRel="2.50"),
    ...
    Setting(section="DHCPv6", name="UseAddress", allowedValue=BooleanValue(), sinceRel="2.48"),
    Setting(section="DHCPv6", name="UseDelegatedPrefix", allowedValue=BooleanValue(), sinceRel="2.50"),
    ...
    Setting(section="DHCPv6", sinceRel="2.43", name="ForceDHCPv6PDOtherInformation", allowedValue=BooleanValue(), tillRel="2.50"),
    ...
    Setting(section="DHCPv6", sinceRel="2.43", name="RouteMetric", allowedValue=NumericValue(), tillRel="2.49"),
    ...
    Setting(section="DHCPv6PrefixDelegation", name="Announce", allowedValue=BooleanValue(), sinceRel="2.47", tillRel="2.50"),
    Setting(section="DHCPv6PrefixDelegation", name="Assign", allowedValue=BooleanValue(), sinceRel="2.46", tillRel="2.50"),
    Setting(section="DHCPv6PrefixDelegation", name="ManageTemporaryAddress", allowedValue=TextValue(), sinceRel="2.48", tillRel="2.50"),
    Setting(section="DHCPv6PrefixDelegation", name="RouteMetric", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.49", tillRel="2.50"),
    Setting(section="DHCPv6PrefixDelegation", name="SubnetId", allowedValue=NumericValue(upper=0x7fffffffffffffff, numberBase=16), sinceRel="2.46", tillRel="2.50"),
    Setting(section="DHCPv6PrefixDelegation", name="Token", allowedValue=TextValue(), sinceRel="2.46", tillRel="2.50"),
    ...
    Setting(section="FlowQueuePIE", name="Handle", allowedValue=NumericValue(lower=1, upper=0xffff, numberBase=16), sinceRel="2.47"),
    Setting(section="FlowQueuePIE", name="PacketLimit", allowedValue=NumericValue(upper=4294967294), sinceRel="2.47"),
    Setting(section="FlowQueuePIE", name="Parent", allowedValue=EitherValue([TextValue(), EnumValue(["root", "clsact", "ingress"])]), sinceRel="2.47"),
    ...
    Setting(section="IPoIB", name="IgnoreUserspaceMulticastGroup", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="IPoIB", name="Mode", allowedValue=EnumValue(["datagram", "connected"]), sinceRel="2.50"),
    Setting(section="IPoIB", name="PartitionKey", allowedValue=NumericValue(lower=0, upper=0xffff), sinceRel="2.50"),
    Setting(section="IPv6AcceptRA", name="DenyList", allowedValue=TextValue(), sinceRel="2.46", tillRel="2.48"),
    Setting(section="IPv6AcceptRA", name="DHCPv6Client", allowedValue=EitherValue([EnumValue(["always"]), BooleanValue()]), sinceRel="2.46"),
    Setting(section="IPv6AcceptRA", name="PrefixAllowList", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="IPv6AcceptRA", name="PrefixDenyList", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="IPv6AcceptRA", name="RouteAllowList", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="IPv6AcceptRA", name="RouteDenyList", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="IPv6AcceptRA", name="RouteMetric", allowedValue=NumericValue(lower=0, upper=4294967295), sinceRel="2.49"),
    ...
    Setting(section="IPv6AcceptRA", name="UseGateway", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="IPv6AcceptRA", name="UseMTU", allowedValue=BooleanValue(), sinceRel="2.50"),
    Setting(section="IPv6AcceptRA", name="UseOnLinkPrefix", allowedValue=BooleanValue()),
    Setting(section="IPv6AcceptRA", name="UseRoutePrefix", allowedValue=BooleanValue(), sinceRel="2.50"),
    ...
    Setting(section="IPv6Prefix", name="Token", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="IPv6Prefix", name="ValidLifetimeSec", allowedValue=TimeValue()),
    Setting(section="IPv6PrefixDelegation", name="DNS", allowedValue=TextValue(), tillRel="2.46"),
    Setting(section="IPv6PrefixDelegation", name="DNSLifetimeSec", allowedValue=TimeValue(), tillRel="2.46"),
    Setting(section="IPv6PrefixDelegation", name="Domains", allowedValue=TextValue(), tillRel="2.46"),
    Setting(section="IPv6PrefixDelegation", name="EmitDNS", allowedValue=BooleanValue(), tillRel="2.46"),
    Setting(section="IPv6PrefixDelegation", name="EmitDomains", allowedValue=BooleanValue(), tillRel="2.46"),
    Setting(section="IPv6PrefixDelegation", name="Managed", allowedValue=BooleanValue(), tillRel="2.46"),
    Setting(section="IPv6PrefixDelegation", name="OtherInformation", allowedValue=BooleanValue(), tillRel="2.46"),
    Setting(section="IPv6PrefixDelegation", name="RouterLifetimeSec", allowedValue=TimeValue(), tillRel="2.46"),
    Setting(section="IPv6PrefixDelegation", name="RouterPreference", allowedValue=EnumValue(["high", "medium", "low", "normal", "default"]), tillRel="2.47"),
    Setting(section="IPv6RoutePrefix", name="Route", allowedValue=TextValue(), sinceRel="2.44"), # TODO: route entry parser
    Setting(section="IPv6SendRA", name="DNS", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="DNSLifetimeSec", allowedValue=TimeValue(), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="Domains", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="EmitDNS", allowedValue=BooleanValue(), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="EmitDomains", allowedValue=BooleanValue(), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="Managed", allowedValue=BooleanValue(), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="OtherInformation", allowedValue=BooleanValue(), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="RouterLifetimeSec", allowedValue=TimeValue(), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="RouterPreference", allowedValue=EnumValue(["high", "medium", "low", "normal", "default"]), sinceRel="2.47"),
    Setting(section="IPv6SendRA", name="UplinkInterface", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Link", name="ActivationPolicy", allowedValue=EnumValue(["up", "always-up", "manual", "always-down", "down", "bound"]), sinceRel="2.48"),
    ...
    Setting(section="Link", name="WakeOnLanPassword", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Login", name="HandleHibernateKeyLongPress", allowedValue=EnumValue(["ignore", "poweroff", "reboot", "halt", "kexec", "suspend", "hibernate", "hybrid-sleep", "suspend-then-hibernate", "lock"]), sinceRel="2.50"),
    ...
    Setting(section="Login", name="HandlePowerKeyLongPress", allowedValue=EnumValue(["ignore", "poweroff", "reboot", "halt", "kexec", "suspend", "hibernate", "hybrid-sleep", "suspend-then-hibernate", "lock"]), sinceRel="2.50"),
    Setting(section="Login", name="HandleRebootKeyLongPress", allowedValue=EnumValue(["ignore", "poweroff", "reboot", "halt", "kexec", "suspend", "hibernate", "hybrid-sleep", "suspend-then-hibernate", "lock"]), sinceRel="2.50"),
    ...
    Setting(section="Login", name="HandleSuspendKeyLongPress", allowedValue=EnumValue(["ignore", "poweroff", "reboot", "halt", "kexec", "suspend", "hibernate", "hybrid-sleep", "suspend-then-hibernate", "lock"]), sinceRel="2.50"),
    ...
    Setting(section="MACVLAN", name="BroadcastMulticastQueueLength", allowedValue=NumericValue(lower=0, upper=4294967294), sinceRel="2.48"),
    ...
    Setting(section="Manager", name="DefaultOOMScoreAdjust", allowedValue=NumericValue(lower=-1000, upper=1000), sinceRel="2.50"),
    ...
    Setting(section="Manager", name="ManagerEnvironment", allowedValue=KeyValuePairListValue(), sinceRel="2.48"),
    ...
    Setting(section="Mount", name="AllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Mount", name="AllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Mount", name="ExecPaths", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="Mount", name="ExecSearchPath", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Mount", name="ManagedOOMMemoryPressure", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="Mount", name="ManagedOOMMemoryPressureLimitPercent", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="Mount", name="ManagedOOMPreference", allowedValue=EnumValue(["none", "avoid", "omit"]), sinceRel="2.48"),
    Setting(section="Mount", name="ManagedOOMSwap", allowedValue=TextValue(), sinceRel="2.47"),
    ...
    Setting(section="Mount", name="MountImages", allowedValue=ListOf(TextValue()), sinceRel="2.47"),
    ...
    Setting(section="Mount", name="NoExecPaths", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="Mount", name="NoNewPrivileges", allowedValue=BooleanValue(), sinceRel="2.39"),
    Setting(section="Mount", name="NUMAMask", allowedValue=EitherValue(args=[EnumValue(["all"]), TextValue()]), sinceRel="2.47"),
    ...
    Setting(section="Mount", name="ProcSubset", allowedValue=EnumValue(["all", "pid"]), sinceRel="2.47"),
    ...
    Setting(section="Mount", name="ProtectProc", allowedValue=EnumValue(["noaccess", "invisible", "ptraceable", "default"]), sinceRel="2.47"),
    ...
    Setting(section="Mount", name="RestrictFileSystems", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Mount", name="RestrictNamespaces", allowedValue=TextValue(), sinceRel="2.33"),
    Setting(section="Mount", name="RestrictNetworkInterfaces", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Mount", name="RootImageOptions", allowedValue=ListOf(EnumValue(["", "root", "root-secondary", "home", "srv", "esp", "xbootldr", "tmp", "var", "usr"])), sinceRel="2.47"),
    ...
    Setting(section="Mount", name="SocketBindAllow", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Mount", name="SocketBindDeny", allowedValue=TextValue(), sinceRel="2.49"),
    ...
    Setting(section="Mount", name="StartupAllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Mount", name="StartupAllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Mount", name="SystemCallLog", allowedValue=ListOf(TextValue()), sinceRel="2.47"),
    ...
    Setting(section="Mount", name="TTYColumns", allowedValue=NumericValue(), sinceRel="2.50"),
    ...
    Setting(section="Mount", name="TTYRows", allowedValue=NumericValue(), sinceRel="2.50"),
    ...
    Setting(section="NetDev", name="Kind", allowedValue=EnumValue(["bond", "bridge", "dummy", "gre", "gretap", "erspan", "ip6gre", "ip6tnl", "ip6gretap", "ipip", "ipvlan", "macvlan", "macvtap", "sit", "tap", "tun", "veth", "vlan", "vti", "vti6", "vxlan", "geneve", "l2tp", "vrf", "vcan", "vxcan", "wireguard", "netdevsim", "fou", "bridge", "dummy", "gre", "gretap", "erspan", "ip6gre", "ip6tnl", "ip6gretap", "ipip", "ipvlan", "macvlan", "macvtap", "sit", "tap", "tun", "veth", "vlan", "vti", "vti6", "vxlan", "geneve", "l2tp", "vrf", "vcan", "vxcan", "wireguard", "netdevsim", "fou", "ipoib"])),
    ...
    Setting(section="Network", name="Gateway", allowedValue=EitherValue(args=[IPValue(), EnumValue(["_dhcp4", "_ipv6ra"])])),
    Setting(section="Network", name="IgnoreCarrierLoss", allowedValue=EitherValue([BooleanValue(), TimeValue()])),
    ...
    Setting(section="Network", name="IPv6PrefixDelegation", allowedValue=EnumValue(["static", "dhcpv6", "yes", "false"]), tillRel="2.46"),
    ...
    Setting(section="Network", name="IPv6SendRA", allowedValue=EnumValue(["static", "dhcpv6", "yes", "false"]), sinceRel="2.47"),
    Setting(section="Network", name="IPv6StableSecretAddress", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Network", name="IPv6Token", allowedValue=IPValue(), tillRel="2.50"),
    ...
    Setting(section="Network", name="ManageForeignRoutingPolicyRules", allowedValue=BooleanValue(), sinceRel="2.49"),
    ...
    Setting(section="Network", name="RouteTable", allowedValue=TextValue(), sinceRel="2.48"),
    ...
    Setting(section="OOM", name="DefaultMemoryPressureDurationSec", allowedValue=NumericValue(), sinceRel="2.48"),
    Setting(section="OOM", name="DefaultMemoryPressureLimit", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="OOM", name="SwapUsedLimit", allowedValue=TextValue(), sinceRel="2.47"),
    ...
    Setting(section="Path", name="TriggerLimitBurst", allowedValue=NumericValue(), sinceRel="2.50"),
    Setting(section="Path", name="TriggerLimitIntervalSec", allowedValue=TimeValue(), sinceRel="2.50"),
    ...
    Setting(section="RoutingPolicyRule", name="Family", allowedValue=EnumValue(["ipv4", "ipv6", "both"]), sinceRel="2.48"),
    ...
    Setting(section="RoutingPolicyRule", name="SuppressInterfaceGroup", allowedValue=NumericValue(lower=0, upper=2147483647), sinceRel="2.50"),
    ...
    Setting(section="RoutingPolicyRule", name="Type", allowedValue=EnumValue(["blackhole", "unreachable", "prohibit"]), sinceRel="2.48"),
    ...
    Setting(section="Scope", name="ManagedOOMPreference", allowedValue=EnumValue(["none", "avoid", "omit"]), sinceRel="2.48"),
    Setting(section="Scope", name="RuntimeMaxSec", allowedValue=TimeValue(), sinceRel="2.44"),
    Setting(section="Scope", name="RuntimeRandomizedExtraSec", allowedValue=TimeValue(), sinceRel="2.50"),
    Setting(section="Scope", name="SocketBindAllow", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Scope", name="SocketBindDeny", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Service", name="AllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Service", name="AllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Service", name="ExecPaths", allowedValue=TextValue(), sinceRel="2.48"),
    ...
    Setting(section="Service", name="ExecSearchPath", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Service", name="ExitType", allowedValue=EnumValue(["main", "cgroup"]), sinceRel="2.50"),
    ...
    Setting(section="Service", name="ManagedOOMMemoryPressure", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="Service", name="ManagedOOMMemoryPressureLimitPercent", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="Service", name="ManagedOOMPreference", allowedValue=EnumValue(["none", "avoid", "omit"]), sinceRel="2.48"),
    Setting(section="Service", name="ManagedOOMSwap", allowedValue=TextValue(), sinceRel="2.47"),
    ...
    Setting(section="Service", name="MountImages", allowedValue=ListOf(TextValue()), sinceRel="2.47"),
    ...
    Setting(section="Service", name="NoExecPaths", allowedValue=TextValue(), sinceRel="2.48"),
    ...
    Setting(section="Service", name="NUMAMask", allowedValue=EitherValue(args=[EnumValue(["all"]), TextValue()]), sinceRel="2.47"),
    ...
    Setting(section="Service", name="ProcSubset", allowedValue=EnumValue(["all", "pid"]), sinceRel="2.47"),
    ...
    Setting(section="Service", name="ProtectProc", allowedValue=EnumValue(["noaccess", "invisible", "ptraceable", "default"]), sinceRel="2.47"),
    ...
    Setting(section="Service", name="RestrictFileSystems", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Service", name="RestrictNamespaces", allowedValue=TextValue(), sinceRel="2.33"),
    Setting(section="Service", name="RestrictNetworkInterfaces", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Service", name="RootImageOptions", allowedValue=ListOf(EnumValue(["", "root", "root-secondary", "home", "srv", "esp", "xbootldr", "tmp", "var", "usr"])), sinceRel="2.47"),
    ...
    Setting(section="Service", name="RuntimeRandomizedExtraSec", allowedValue=TimeValue(), sinceRel="2.50"),
    ...
    Setting(section="Service", name="SocketBindAllow", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Service", name="SocketBindDeny", allowedValue=TextValue(), sinceRel="2.49"),
    ...
    Setting(section="Service", name="StartupAllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Service", name="StartupAllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Service", name="SystemCallLog", allowedValue=ListOf(TextValue()), sinceRel="2.47"),
    ...
    Setting(section="Service", name="TTYColumns", allowedValue=NumericValue(), sinceRel="2.50"),
    ...
    Setting(section="Service", name="TTYRows", allowedValue=NumericValue(), sinceRel="2.50"),
    ...
    Setting(section="Slice", name="AllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Slice", name="AllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Slice", name="ManagedOOMPreference", allowedValue=EnumValue(["none", "avoid", "omit"]), sinceRel="2.48"),
    Setting(section="Slice", name="RestrictNetworkInterfaces", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Slice", name="SocketBindAllow", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Slice", name="SocketBindDeny", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Slice", name="StartupAllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Slice", name="StartupAllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Socket", name="Accept", allowedValue=BooleanValue()),
    Setting(section="Socket", name="AllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Socket", name="AllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Socket", name="ExecPaths", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="Socket", name="ExecSearchPath", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Socket", name="FlushPending", allowedValue=BooleanValue(), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="ManagedOOMMemoryPressure", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="Socket", name="ManagedOOMMemoryPressureLimitPercent", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="Socket", name="ManagedOOMPreference", allowedValue=EnumValue(["none", "avoid", "omit"]), sinceRel="2.48"),
    Setting(section="Socket", name="ManagedOOMSwap", allowedValue=TextValue(), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="MountImages", allowedValue=ListOf(TextValue()), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="NoExecPaths", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="Socket", name="NoNewPrivileges", allowedValue=BooleanValue(), sinceRel="2.39"),
    Setting(section="Socket", name="NUMAMask", allowedValue=EitherValue(args=[EnumValue(["all"]), TextValue()]), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="ProcSubset", allowedValue=EnumValue(["all", "pid"]), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="ProtectProc", allowedValue=EnumValue(["noaccess", "invisible", "ptraceable", "default"]), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="RestrictFileSystems", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Socket", name="RestrictNamespaces", allowedValue=TextValue(), sinceRel="2.33"),
    Setting(section="Socket", name="RestrictNetworkInterfaces", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Socket", name="RootImageOptions", allowedValue=ListOf(EnumValue(["", "root", "root-secondary", "home", "srv", "esp", "xbootldr", "tmp", "var", "usr"])), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="SocketBindAllow", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Socket", name="SocketBindDeny", allowedValue=TextValue(), sinceRel="2.49"),
    ...
    Setting(section="Socket", name="StartupAllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Socket", name="StartupAllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Socket", name="SystemCallLog", allowedValue=ListOf(TextValue()), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="Timestamping", allowedValue=EnumValue(["off", "us", "usec", "µs", "ns", "nsec"]), sinceRel="2.47"),
    ...
    Setting(section="Socket", name="TTYColumns", allowedValue=NumericValue(), sinceRel="2.50"),
    ...
    Setting(section="Socket", name="TTYRows", allowedValue=NumericValue(), sinceRel="2.50"),
    ...
    Setting(section="Swap", name="AllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Swap", name="AllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Swap", name="ExecPaths", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="Swap", name="ExecSearchPath", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Swap", name="ManagedOOMMemoryPressure", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="Swap", name="ManagedOOMMemoryPressureLimitPercent", allowedValue=TextValue(), sinceRel="2.47"),
    Setting(section="Swap", name="ManagedOOMPreference", allowedValue=EnumValue(["none", "avoid", "omit"]), sinceRel="2.48"),
    Setting(section="Swap", name="ManagedOOMSwap", allowedValue=TextValue(), sinceRel="2.47"),
    ...
    Setting(section="Swap", name="MountImages", allowedValue=ListOf(TextValue()), sinceRel="2.47"),
    ...
    Setting(section="Swap", name="NoExecPaths", allowedValue=TextValue(), sinceRel="2.48"),
    Setting(section="Swap", name="NoNewPrivileges", allowedValue=BooleanValue(), sinceRel="2.39"),
    Setting(section="Swap", name="NUMAMask", allowedValue=EitherValue(args=[EnumValue(["all"]), TextValue()]), sinceRel="2.47"),
    ...
    Setting(section="Swap", name="ProcSubset", allowedValue=EnumValue(["all", "pid"]), sinceRel="2.47"),
    ...
    Setting(section="Swap", name="ProtectProc", allowedValue=EnumValue(["noaccess", "invisible", "ptraceable", "default"]), sinceRel="2.47"),
    ...
    Setting(section="Swap", name="RestrictFileSystems", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Swap", name="RestrictNamespaces", allowedValue=TextValue(), sinceRel="2.33"),
    Setting(section="Swap", name="RestrictNetworkInterfaces", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Swap", name="RootImageOptions", allowedValue=ListOf(EnumValue(["", "root", "root-secondary", "home", "srv", "esp", "xbootldr", "tmp", "var", "usr"])), sinceRel="2.47"),
    ...
    Setting(section="Swap", name="SocketBindAllow", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Swap", name="SocketBindDeny", allowedValue=TextValue(), sinceRel="2.49"),
    ...
    Setting(section="Swap", name="StartupAllowedCPUs", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Swap", name="StartupAllowedMemoryNodes", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Swap", name="SystemCallLog", allowedValue=ListOf(TextValue()), sinceRel="2.47"),
    ...
    Setting(section="Swap", name="TTYColumns", allowedValue=NumericValue(), sinceRel="2.50"),
    ...
    Setting(section="Swap", name="TTYRows", allowedValue=NumericValue(), sinceRel="2.50"),
    ...
    Setting(section="Time", name="ConnectionRetrySec", allowedValue=NumericValue(lower=1), sinceRel="2.48"),
    ...
    Setting(section="Time", name="SaveIntervalSec", allowedValue=TimeValue(), sinceRel="2.50"),
    Setting(section="Timer", name="AccuracySec", allowedValue=TimeValue()),
    Setting(section="Timer", name="FixedRandomDelay", allowedValue=BooleanValue(), sinceRel="2.47"),
    ...
    Setting(section="Unit", name="AssertCPUPressure", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Unit", name="AssertIOPressure", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Unit", name="AssertMemoryPressure", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Unit", name="BPFProgram", allowedValue=TextValue(), sinceRel="2.49"),
    ...
    Setting(section="Unit", name="ConditionCPUFeature", allowedValue=EnumValue(["abm", "adx", "aes", "apic", "avx", "avx2", "bmi1", "bmi2", "clflush", "cmov", "constant_tsc", "cx16", "cx8", "de", "f16c", "fma3", "fpu", "fxsr", "ht", "lahf_lm", "lm", "mca", "mce", "mmx", "monitor", "movbe", "msr", "mtrr", "osxsave", "pae", "pat", "pclmul", "pge", "pni", "popcnt", "pse", "pse36", "rdrand", "rdseed", "rdtscp", "sep", "sha_ni", "sse", "sse2", "sse4_1", "sse4_2", "ssse3", "syscall", "tsc", "vme", "xsave"]), sinceRel="2.48"),
    Setting(section="Unit", name="ConditionCPUPressure", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Unit", name="ConditionFirmware", allowedValue=TextValue(), sinceRel="2.49"),
    ...
    Setting(section="Unit", name="ConditionIOPressure", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="Unit", name="ConditionMemoryPressure", allowedValue=TextValue(), sinceRel="2.50"),
    Setting(section="Unit", name="ConditionNeedsUpdate", allowedValue=TextValue(), sinceRel="2.15"),
    Setting(section="Unit", name="ConditionOSRelease", allowedValue=TextValue(), sinceRel="2.49"),
    ...
    Setting(section="Unit", name="OnSuccess", allowedValue=UnitListValue(), sinceRel="2.49"),
    ...
    Setting(section="Unit", name="PropagatesStopTo", allowedValue=UnitListValue(), sinceRel="2.49"),
    ...
    Setting(section="Unit", name="StopPropagatedFrom", allowedValue=UnitListValue(), sinceRel="2.49"),
    ...
    Setting(section="Unit", name="Upholds", allowedValue=UnitListValue(), sinceRel="2.49"),
    Setting(section="Unit", name="Wants", allowedValue=UnitListValue(), dropinproc=DropinAdditive()),
    Setting(section="Upload", name="NetworkTimeoutSec", allowedValue=TimeValue(), sinceRel="2.49"),
    Setting(section="Upload", name="ServerCertificateFile", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Upload", name="ServerKeyFile", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Upload", name="TrustedCertificateFile", allowedValue=TextValue(), sinceRel="2.49"),
    Setting(section="Upload", name="URL", allowedValue=IPorUrlValue(), sinceRel="2.49"),
    Setting(section="User", name="CrashChVT", allowedValue=TextValue(), tillRel="2.27"),
    Setting(section="VLAN", name="EgressQOSMaps", allowedValue=TextValue(), sinceRel="2.48"),
    ...
    Setting(section="VLAN", name="IngressQOSMaps", allowedValue=TextValue(), sinceRel="2.48"),
    ...
    Setting(section="VXLAN", name="Independent", allowedValue=BooleanValue(), sinceRel="2.47"),
    ...
    Setting(section="WireGuard", name="AllowedIPs", allowedValue=TextValue(), sinceRel="2.50"),
    ...
    Setting(section="WireGuardPeer", name="AllowedIPs", allowedValue=TextValue(), sinceRel="2.50"),
